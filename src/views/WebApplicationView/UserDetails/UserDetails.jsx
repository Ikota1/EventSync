          ...
          <div className="col-span-4 sm:col-span-9 w-[700px]">
            <div className="bg-gray-900 shadow rounded-lg p-6">
              ...
              <div className="flex justify-center items-center gap-6 my-6">
                <a className="text-white hover:text-gray-700" aria-label="Visit TrendyMinds LinkedIn" href=""
                ...
                <a className="text-white hover:text-gray-700" aria-label="Visit TrendyMinds YouTube" href=""
                ...
                <a className="text-white hover:text-gray-700" aria-label="Visit TrendyMinds Facebook" href=""
                ...
                <a className="text-white hover:text-gray-700" aria-label="Visit TrendyMinds Instagram" href=""
                  target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="h-6">
                    <path fill="currentColor"
