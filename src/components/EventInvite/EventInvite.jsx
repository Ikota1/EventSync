...
const EventInvite = () => {
  ...
  return (
    <div className='bg-red'>
      <button onClick={toggleDropdown} data-dropdown-toggle="dropdownUsers" data-dropdown-placement="bottom" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Add Friends
      ...
      {isDropdownOpen && (
        <div id="dropdownUsers" className="z-10 bg-white rounded-lg shadow w-60 dark:bg-gray-700" >
          {userFriends.length === 0 ? ( 
            <p className="py-2 px-4 text-gray-700 dark:text-gray-200">You have no friends at the moment. Go to the <Link to="../dashboard" className="text-blue-700 hover:underline dark:text-blue-400">dashboard</Link> to look for new friends.</p>
          ) : (
            <>
