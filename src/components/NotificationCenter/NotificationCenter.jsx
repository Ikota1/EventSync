...
const NotificationCenter = ({ onClick }) => {
    ...
    return (
     <div className="notification-center">
        <div onClick={handleNotificationCenterClick} className={`notification-badge ${totalNotifications > 0 ? 'bg-purple-500 text-white' : 'text-white'} flex items-center cursor-pointer rounded-full p-1`}>
