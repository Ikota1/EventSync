                ...
                <label htmlFor="">
                  ...
                  <div className="flex items-center justify-between gap-6">
                    <button
                      ...
                      className="w-[30%] full text-white bg-thirdly hover:bg-thirdlyHover font-medium rounded-lg text-sm px-5 py-2 text-center"
                    >
                      Close
                    </button>
                    <button type="submit" className="w-[30%] full text-white bg-thirdly hover:bg-thirdlyHover font-medium rounded-lg text-sm px-5 py-2 text-center">
                      Create
                    </button>
                  </div>
                </label>
